...
public val EventService.messageReactionRemoveEvent: EventMapper<GatewayChatMessageReactionDeletedEvent, MessageReactionRemoveEvent> get() = mapper { client, event ->
