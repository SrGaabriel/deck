...
import io.github.srgaabriel.deck.gateway.event.type.GatewayServerChannelCreatedEvent
...
internal val EventService.serverChannelCreate: EventMapper<GatewayServerChannelCreatedEvent, ServerChannelCreateEvent> get() = mapper { client, event ->
