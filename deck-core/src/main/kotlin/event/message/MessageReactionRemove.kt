...
import io.github.srgaabriel.deck.gateway.event.type.GatewayChatMessageReactionDeletedEvent
import java.util.*
...
internal val EventService.messageReactionRemove: EventMapper<GatewayChatMessageReactionDeletedEvent, MessageReactionRemoveEvent> get() = mapper { client, event ->
