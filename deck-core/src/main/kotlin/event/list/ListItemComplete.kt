...
import io.github.srgaabriel.deck.gateway.event.type.GatewayListItemCompletedEvent
...
internal val EventService.listItemComplete: EventMapper<GatewayListItemCompletedEvent, ListItemCompleteEvent> get() = mapper { client, event ->
