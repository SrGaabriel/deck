...
import io.github.srgaabriel.deck.gateway.event.type.GatewayForumTopicReactionDeletedEvent
import java.util.*
 ...
 */
public data class ForumTopicReactionRemoveEvent(
...
internal val EventService.forumTopicReactionRemove: EventMapper<GatewayForumTopicReactionDeletedEvent, ForumTopicReactionRemoveEvent> get() = mapper { client, event ->
