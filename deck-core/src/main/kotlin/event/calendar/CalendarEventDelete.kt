...
import io.github.srgaabriel.deck.gateway.event.type.GatewayCalendarEventDeletedEvent
...
internal val EventService.calendarEventDelete: EventMapper<GatewayCalendarEventDeletedEvent, CalendarEventDeleteEvent> get() = mapper { client, event ->
