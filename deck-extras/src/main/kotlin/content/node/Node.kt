package io.github.srgaabriel.deck.extras.content.node

import io.github.srgaabriel.deck.extras.content.RawMentionType
import io.github.srgaabriel.deck.extras.content.RawMessageContentNodeLeavesMarkType
import io.github.srgaabriel.deck.extras.content.RawMessageContentNodeType
import kotlinx.serialization.json.JsonPrimitive
import java.util.*
import io.github.srgaabriel.deck.common.Embed as EmbedContent
...
public sealed class Node(
    ...
    public class Paragraph(content: List<Node>, insideQuoteBlock: Boolean = false) : Node(
        ...
        public class Link(public val link: String, public val text: String, internal val leaf: Text.Leaf = Text.Leaf(
            text)
        ): Node(
            `object` = "inline",
